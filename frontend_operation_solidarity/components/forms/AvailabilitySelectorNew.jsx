      ...
      <div className="mt-2 flex flex-col">
        <div>
          <label className="inline-flex items-center mr-4">
            <input
              type="checkbox"
              className="form-checkbox text-secondary-600 rounded focus:ring-secondary-500 border-gray-300"
              checked={isAllSelected}
              onChange={(e) => handleSelectAllDays(e.target.checked)}
            />
            <span className="ml-2 text-gray-700">
              {labels[language].selectAll}
            </span>
          </label>
        </div>
          ...
          {weekDaysLocal.map((localDay) => {
            ...
            return (
              ...
              >
                ...
                />
                <span className="ml-2 text-gray-700">{localDay}</span>
              </label>
            );
          })}
        </div>
